      ...
      <header className="border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        <div className="mx-auto flex w-full max-w-5xl items-center gap-6 px-4 py-3">
          ...
          <nav className="flex flex-wrap items-center gap-4 text-xs">
            <a href="/admin/dashboard" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100">Admin Dashboard</a>
            <a href="/admin/analytics" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100">Analytics</a>
            <a href="/admin/owners" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100">Owners</a>
            <a href="/admin/pm-claims" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100">PM Claims</a>
            <a href="/admin/properties" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100">Properties</a>
            <a href="/admin" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100">Reviews</a>
